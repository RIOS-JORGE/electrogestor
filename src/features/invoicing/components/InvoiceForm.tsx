                ...
                <div className="space-y-3">
                  {fields.map((field, index) => {
                    ...
                    if (item.type === 'material') {
                      return (
                        <div key={field.id} className="flex flex-col gap-3 rounded-lg border border-gray-100 bg-gray-50/50 p-3 sm:flex-row sm:items-end sm:gap-2 sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0">
